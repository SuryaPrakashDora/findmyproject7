...
public class ResearcherController {
    ...
    public Researcher updateResearcher(@PathVariable("researcherId") int researcherId, Researcher researcher) {
    ...
    public List<Project> getResearcherProjects(@PathVariable("researcherId") int researcherId) {
        return researcherJpaService.ResearcherProjects(researcherId);
    }
}